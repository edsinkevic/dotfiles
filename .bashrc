...
alias ef='$EDITOR'     # 'ef' opens given file(s) for editing
...
export PATH="$PATH:/home/edvin/.ghcup/bin"
export PATH="$PATH:/home/edvin/.dtos-local/bin"
[ -f "/home/edvin/.ghcup/env" ] && source "/home/edvin/.ghcup/env" # ghcup-env
...
alias funcvpn="sudo openconnect vpn2.vu.lt"
alias swapescapeon="setxkbmap -option caps:swapescape"
...
alias errxmonad='$EDITOR $HOME/.xmonad/xmonad.errors'
...
### CONFIG ALIASES
alias cxmonad='$EDITOR $HOME/.xmonad/xmonad.hs'
